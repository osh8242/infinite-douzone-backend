...
--	"MN_4_1_1" VARCHAR2(100 BYTE),
     "INCOME_CLASSFICATION" VARCHAR2(100 BYTE) DEFAULT 'empRegistration',
...
INSERT INTO HRHR.SADEDUCT (CD_DEDUCT, NM_DEDUCT, YN_BONUS, YN_SAL, RATE, STATIC) VALUES('501', '국민연금', NULL, 'Y', '4.5', 'Y');
INSERT INTO HRHR.SADEDUCT (CD_DEDUCT, NM_DEDUCT, YN_BONUS, YN_SAL, RATE, STATIC) VALUES('502', '건강보험', NULL, 'Y', '3.545', 'Y');
INSERT INTO HRHR.SADEDUCT (CD_DEDUCT, NM_DEDUCT, YN_BONUS, YN_SAL, RATE, STATIC) VALUES('503', '고용보험', 'Y', 'Y', '12.81', 'Y');
INSERT INTO HRHR.SADEDUCT (CD_DEDUCT, NM_DEDUCT, YN_BONUS, YN_SAL, RATE, STATIC) VALUES('504', '장기요양보험료', NULL, 'Y', '0.9', 'Y');
INSERT INTO HRHR.SADEDUCT (CD_DEDUCT, NM_DEDUCT, YN_BONUS, YN_SAL, RATE, STATIC) VALUES('505', '소득세', NULL, 'Y', '간이세액', 'Y');
INSERT INTO HRHR.SADEDUCT (CD_DEDUCT, NM_DEDUCT, YN_BONUS, YN_SAL, RATE, STATIC) VALUES('506', '지방소득세', NULL, 'Y', '소득세 * 0.1', 'Y');

-- INSERTING INTO HRHR."SAL"
INSERT INTO HRHR.SAALLOW (CD_ALLOW, NM_ALLOW, YN_TAX, SAL_DIVISION, COMMONLY_YN, MONTHLY_YN) VALUES ('101', '기본급', 'Y', 'SAL', 'Y', 'Y');
INSERT INTO HRHR.SAALLOW (CD_ALLOW, NM_ALLOW, YN_TAX, SAL_DIVISION, COMMONLY_YN, MONTHLY_YN) VALUES ('102', '상여', 'Y', 'BONUS', 'N', 'N');